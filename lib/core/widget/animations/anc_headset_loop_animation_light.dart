// anc_headset_loop_animation_light.dart
//
...
class AncHeadsetLoopAnimationLight extends StatefulWidget {
...
class _WavePainterLight extends CustomPainter {
  final double waveOpacity;
  final double waveScale;
  _WavePainterLight({required this.waveOpacity, required this.waveScale});
